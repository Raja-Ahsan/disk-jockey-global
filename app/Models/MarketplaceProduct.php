...
class MarketplaceProduct extends Model
{
    ...
    protected $fillable = [
        ...
        'sku', 'stock', 'category_id', 'image', 'gallery', 'product_type',
    ...
    {
        return $this->hasMany(OrderItem::class, 'marketplace_product_id');
    }
    ...
    {
        return $this->hasMany(MarketplaceProductVariation::class, 'marketplace_product_id')->orderBy('sort_order');
    }

    public function defaultVariation()
    {
        return $this->hasOne(MarketplaceProductVariation::class, 'marketplace_product_id')->where('is_default', true);
    }
    ...
    public function getImageUrlAttribute()
    {
        ...
        return asset('images/shop-img-001.png');
    }
