...
<main class="overflow-hidden bg-[#161616] py-12">
    <div class="container mx-auto px-6 lg:px-16">
        ...
        <nav class="mb-8 text-gray-400 text-sm">
            ...
            <a href="{{ route('marketplace.index') }}" class="hover:text-[#FFD900]">Marketplace</a>
            <span class="mx-2">/</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
                ...
                @endphp
                <form id="variationForm" action="{{ route('marketplace.cart.add', $product->id) }}" method="POST" class="space-y-6 mb-6">
                    @csrf
                ...
                @if($hasStock)
                <form action="{{ route('marketplace.cart.add', $product->id) }}" method="POST" class="space-y-4 mb-6">
                    @csrf
                ...
                <div class="flex gap-4 mb-6">
                    <a href="{{ route('marketplace.cart.index') }}" class="flex-1 bg-[#1F1F1F] border border-[#282828] text-white py-3 text-center rounded-lg hover:bg-[#282828] transition-colors font-semibold">
                        View Cart
                    </a>
                    @if(session('marketplace_cart') && count(session('marketplace_cart')) > 0)
                    <a href="{{ route('marketplace.checkout.index') }}" class="flex-1 bg-[#FFD900] text-[#333333] py-3 text-center rounded-lg hover:bg-[#FFA500] transition-colors font-bold">
                        Checkout
                    </a>
                    @endif
                </div>
        ...
        <div class="border-t border-[#282828] pt-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="product-card group">
                    <a href="{{ route('marketplace.products.show', $relatedProduct->id) }}">
