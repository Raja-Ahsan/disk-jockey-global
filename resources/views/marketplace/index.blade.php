...
<main class="overflow-hidden bg-[#161616]">
    ...
    <section class="relative py-28 flex items-center bg-[#000000] overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/hero-bg-image.png') }}" alt="Marketplace Background" class="w-full h-full object-cover opacity-40">
        </div>
    ...
    <section class="py-20">
        <div class="container mx-auto px-6 lg:px-16">
            <!-- Filters -->
            <div class="mb-8">
                <form method="GET" action="{{ route('marketplace.index') }}" class="flex flex-col md:flex-row gap-4">
                    <input type="text" 
                           name="search" 
                    ...
                    @if(request()->hasAny(['search', 'category']))
                        <a href="{{ route('marketplace.index') }}" class="btn secondary-button whitespace-nowrap">Clear</a>
                    @endif
                </form>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
                ...
                <div class="product-card group" data-aos="fade-up">
                    <a href="{{ route('marketplace.products.show', $product->id) }}">
                    ...
                    @if($product->has_stock)
                        <a href="{{ route('marketplace.products.show', $product->id) }}" class="mt-4 block w-full py-3 bg-[#1F1F1F] text-white border border-[#282828] hover:bg-[#FFD900] hover:text-black hover:border-[#FFD900] transition-all font-bold uppercase text-xs tracking-widest text-center">
    ...
    <section class="py-20 bg-[#1F1F1F] text-center border-t border-[#282828]">
        <div class="container mx-auto px-6 lg:px-16" data-aos="zoom-in">
            ...
            <p class="text-gray-300 font-normal text-lg mb-8">Discover gear, digital packs, and exclusive marketplace finds.</p>
