                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.marketplace-products.index') }}"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg text-white transition-all {{ request()->routeIs('admin.marketplace-products.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            <span class="font-semibold">Marketplace Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.marketplace-categories.index') }}"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg text-white transition-all {{ request()->routeIs('admin.marketplace-categories.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                            </svg>
                            <span class="font-semibold">Marketplace Categories</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.plan-my-event.index') }}"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg text-white transition-all {{ request()->routeIs('admin.plan-my-event.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                            </svg>
                            <span class="font-semibold">Plan My Event</span>
                        </a>
                    </li>
                </ul>
            </nav>
