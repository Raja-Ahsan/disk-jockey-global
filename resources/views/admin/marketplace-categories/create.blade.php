...
@section('page-description', 'Add a new marketplace category or subcategory')
...
<div class="space-y-6">
    ...
    <div class="bg-[#1F1F1F] border border-[#282828] rounded-xl p-8">
        <form action="{{ route('admin.marketplace-categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
