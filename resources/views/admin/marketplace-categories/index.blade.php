...
@section('title', 'Manage Marketplace Categories')
@section('page-title', 'Manage Marketplace Categories')
@section('page-description', 'Organize marketplace products with categories and subcategories')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-bold text-white">Marketplace Categories</h2>
            <p class="text-gray-400 text-sm">Organize your marketplace products with categories and subcategories</p>
        </div>
        <a href="{{ route('admin.marketplace-categories.create') }}" class="btn primary-button">
    ...
    <div class="bg-[#1F1F1F] border border-[#282828] rounded-xl overflow-hidden">
        ...
        <div class="p-6">
                ...
                <div class="bg-[#161616] border border-[#282828] rounded-lg p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            <a href="{{ route('admin.marketplace-categories.show', $category->id) }}" class="text-[#FFD900] hover:underline text-sm">View</a>
                            <a href="{{ route('admin.marketplace-categories.edit', $category->id) }}" class="text-blue-400 hover:underline text-sm">Edit</a>
                            <form action="{{ route('admin.marketplace-categories.destroy', $category->id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this category? All subcategories will also be deleted.')">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="ml-8 mt-4 pl-4 border-l-2 border-[#282828] space-y-3">
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-[#282828] last:border-0">
                            ...
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.marketplace-categories.edit', $subcategory->id) }}" class="text-blue-400 hover:underline text-sm">Edit</a>
                                <form action="{{ route('admin.marketplace-categories.destroy', $subcategory->id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this subcategory?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-400 hover:underline text-sm">Delete</button>
                                </form>
                        ...
                        @endforeach
                        <a href="{{ route('admin.marketplace-categories.create', ['parent_id' => $category->id]) }}" class="text-[#FFD900] hover:underline text-sm inline-flex items-center gap-1">
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-400 mb-6">Create your first marketplace category to organize products</p>
                <a href="{{ route('admin.marketplace-categories.create') }}" class="btn primary-button inline-block">
                    Create Category
                </a>
            </div>
            @endif
