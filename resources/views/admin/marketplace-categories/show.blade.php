...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.marketplace-categories.edit', $category->id) }}" class="btn primary-button">
                Edit Category
            </a>
            <a href="{{ route('admin.marketplace-categories.index') }}" class="btn secondary-button">
                Back to List
            </a>
        </div>
    </div>
            ...
            <div class="bg-[#1F1F1F] border border-[#282828] rounded-xl p-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-3 bg-[#161616] rounded-lg">
                        ...
                        <a href="{{ route('admin.marketplace-categories.show', $subcategory->id) }}" class="text-[#FFD900] hover:underline text-sm">View</a>
                    </div>
                    @endforeach
                </div>
            </div>
