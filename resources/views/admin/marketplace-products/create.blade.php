...
@section('title', 'Create Marketplace Product')
@section('page-title', 'Create Marketplace Product')
@section('page-description', 'Add a new product to the marketplace catalog')
        ...
        <form action="{{ route('admin.marketplace-products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
            ...
            <div class="mb-8 pb-6 border-b border-[#282828]">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="flex items-center p-4 border-2 border-[#282828] rounded-lg cursor-pointer hover:border-[#FFD900] transition-colors product-type-option" data-type="simple">
                        <input type="radio" name="product_type" value="simple" checked class="sr-only product-type-radio">
                        <div class="flex-1">
                        ...
                        <svg class="w-6 h-6 text-[#FFD900] hidden check-icon" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                    </label>
                    <label class="flex items-center p-4 border-2 border-[#282828] rounded-lg cursor-pointer hover:border-[#FFD900] transition-colors product-type-option" data-type="variable">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div id="variablePricing" class="hidden">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-1">
                            <a href="{{ route('admin.marketplace-categories.create') }}" target="_blank" class="text-[#FFD900] hover:underline">Create new category</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="variationsSection" class="mt-8 pt-6 border-t border-[#282828] hidden">
            ...
            <div class="mt-8 pt-6 border-t border-[#282828] flex flex-col sm:flex-row gap-4 justify-end">
                <a href="{{ route('admin.marketplace-products.index') }}" class="px-6 py-3 bg-[#282828] text-white rounded-lg hover:bg-[#353535] transition-colors text-center">
                    Cancel
                </a>
...
document.getElementById('addVariation')?.addEventListener('click', function() {
    ...
    const variationHtml = `
        <div class="variation-item bg-[#161616] border border-[#282828] rounded-lg p-6" data-index="${variationCount}">
            <div class="flex justify-between items-center mb-4">
                <h4 class="text-white font-bold">Variation #${variationCount}</h4>
...
// Initialize product type visual
document.querySelector('.product-type-radio[value="simple"]').dispatchEvent(new Event('change'));
</script>
