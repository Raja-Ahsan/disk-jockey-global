...
@section('title', 'Marketplace Product Details')
@section('page-title', 'Marketplace Product Details')
@section('page-description', 'View marketplace product information')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.marketplace-products.edit', $product->id) }}" class="btn primary-button">
                Edit Marketplace Product
            </a>
            <a href="{{ route('admin.marketplace-products.index') }}" class="btn secondary-button">
                Back to List
            </a>
        </div>
    </div>
            ...
            <div class="bg-[#1F1F1F] border border-[#282828] rounded-xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-white font-semibold">{{ $product->productCategory->full_name ?? 'N/A' }}</p>
                    </div>
                    <div>
